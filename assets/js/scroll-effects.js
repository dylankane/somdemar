...
sr.reveal('.quote-text', { origin: 'top', delay: 200 });
sr.reveal('.quote-logo', { origin: 'bottom', delay: 200 });
...
sr.reveal('.top-row', { origin: 'right', delay: 300, distance: '200px' });
sr.reveal('.video-row', { origin: 'left', delay: 300, distance: '200px' });
sr.reveal('.bottom-row', { origin: 'right', delay: 300, distance: '200px' });
...
sr.reveal('.dish-cards-section .section-title', { origin: 'top', delay: 300, distance: '60px' });
sr.reveal('.cards-container', { origin: 'right', delay: 400, distance: '150px', duration: 1500 });
